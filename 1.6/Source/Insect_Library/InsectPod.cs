    ...
    public class InsectPod : Building, IThingHolder, IOpenable
    {
        ...
        protected override void DrawAt(Vector3 drawLoc, bool flip = false)
		{
            ...
            if (this.HasPawn)
            {
                Vector3 drawLoc2 = base.Position.ToVector3ShiftedWithAltitude(AltitudeLayer.BuildingOnTop) + this.Extension.innerPawnDrawOffset;
                this.Pawn.Rotation = this.Rotation;
                //this.Pawn.Drawer.DrawAt(drawLoc2 + FloatingOffset(drawTick));
                this.Pawn.Drawer.renderer.RenderPawnAt(drawLoc, Pawn.Rotation);
                //this.Pawn.Drawer.renderer.(phase, drawLoc2 + FloatingOffset(drawTick), null, false);
        ...
        protected override void Tick()
        {
            ...
            {
                this.Seed?.Tick();
                this.Pawn.needs.NeedsTrackerTickInterval(150);
