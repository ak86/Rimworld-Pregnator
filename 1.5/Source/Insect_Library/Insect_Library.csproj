...
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <ProjectGuid>{74AC9E12-642D-4A5D-857E-97F37BC4077F}</ProjectGuid>
    <OutputType>Library</OutputType>
    <AppDesignerFolder>Properties</AppDesignerFolder>
    <RootNamespace>Insect_Library</RootNamespace>
    <AssemblyName>Insect_Library</AssemblyName>
  ...
  <ItemGroup>
    <Compile Include="DNP_DefOf.cs" />
    <Compile Include="Hediff_Seeded.cs" />
    <Compile Include="InsectPod.cs" />
    <Compile Include="JobDriver_Seed.cs" />
    <Compile Include="JobDriver_CarryVictimToHive.cs" />
    <Compile Include="JobGiver_Seed.cs" />
    <Compile Include="JobGiver_FindVictimToHive.cs" />
    <Compile Include="ModExtension_PodJob.cs" />
    <Compile Include="ModExtension_Seeded.cs" />
    <Compile Include="ModExtension_InsectPod.cs" />
    <Compile Include="PatchMain.cs" />
    <Compile Include="Patch_Posture.cs" />
    <Compile Include="Properties\AssemblyInfo.cs" />
    <Compile Include="ThinkNode_Race.cs" />
    <Compile Include="ThinkNode_IsInsect.cs" />
  </ItemGroup>
  <ItemGroup>
    <Reference Include="0Harmony, Version=2.3.3.0, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>..\packages\Lib.Harmony.2.3.3\lib\net472\0Harmony.dll</HintPath>
    </Reference>
    <Reference Include="Assembly-CSharp, Version=1.5.8847.21611, Culture=neutral, processorArchitecture=MSIL">
